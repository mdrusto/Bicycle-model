...
#define S_FUNCTION_NAME lateral_dyn_constrained_msf
#endif
...
( SimStruct * S , int_T tid ) { kupbxuab32i * dw = ( kupbxuab32i * )
ssGetDWork ( S , 0 ) ; const real_T * i_clu551xwlz = ( real_T * )
ssGetInputPortSignal ( S , 0 ) ; const real_T * i_bajgc2bsb3 = ( real_T * )
ssGetInputPortSignal ( S , 1 ) ; const real_T * i_aeu0t1x5y0 = ( real_T * )
ssGetInputPortSignal ( S , 2 ) ; real_T * o_B_1_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; if ( tid == 0 ) { lateral_dyn_constrained (
i_clu551xwlz , i_bajgc2bsb3 , i_aeu0t1x5y0 , o_B_1_1 ) ; } } static void
...
( S , 2 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 1 ) ) return ; if ( !
...
mr_lateral_dyn_constrained_RegisterSimStateChecksum ( S ) ;
...
mr_lateral_dyn_constrained_MdlInfoRegFcn ( S , "lateral_dyn_constrained" , &
retVal ) ; if ( ! retVal ) return ; }
#endif
#if SS_SFCN_FOR_SIM
if ( ssSetNumDWork ( S , 1 ) ) { int mdlrefDWTypeId ; ssRegMdlRefDWorkType (
S , & mdlrefDWTypeId ) ; if ( mdlrefDWTypeId == INVALID_DTYPE_ID ) return ;
if ( ! ssSetDataTypeSize ( S , mdlrefDWTypeId , sizeof ( kupbxuab32i ) ) )
...
static void mdlSetupRuntimeResources ( SimStruct * S ) { kupbxuab32i * dw = (
kupbxuab32i * ) ssGetDWork ( S , 0 ) ; void * sysRanPtr = ( NULL ) ; int
sysTid = 0 ; ssGetContextSysRanBCPtr ( S , & sysRanPtr ) ; ssGetContextSysTid
( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } iegb4msjuu
...
* S , int_T tid ) { kupbxuab32i * dw = ( kupbxuab32i * ) ssGetDWork ( S , 0 )
; const real_T * i_clu551xwlz = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ;
const real_T * i_bajgc2bsb3 = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ;
const real_T * i_aeu0t1x5y0 = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ;
real_T * o_B_1_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid !=
CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { lateral_dyn_constrained (
i_clu551xwlz , i_bajgc2bsb3 , i_aeu0t1x5y0 , o_B_1_1 ) ; } } static void
mdlTerminate ( SimStruct * S ) { kupbxuab32i * dw = ( kupbxuab32i * )
ssGetDWork ( S , 0 ) ; nn2wvzakqe ( & ( dw -> rtm ) ) ; return ; }
...
mr_lateral_dyn_constrained_GetDWork ( ssGetDWork ( S , 0 ) ) ;
...
mr_lateral_dyn_constrained_SetDWork ( ssGetDWork ( S , 0 ) ,
