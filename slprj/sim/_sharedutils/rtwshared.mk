...
MODEL                   = rtwshared
MODULES                 = look2_binlxpw.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
...
NUMST                   = 
NCSTATES                = 0
BUILDARGS               = MATLAB_ROOT=%MATLAB_ROOT% ALT_MATLAB_ROOT=%ALT_MATLAB_ROOT% MATLAB_BIN=%MATLAB_BIN% ALT_MATLAB_BIN=%ALT_MATLAB_BIN%  OPTS="-DNRT"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
